...
def exact_sum(CC,t1,t2,t3):
    ...
    for state in basis[nstart:]:
        ...
        # Ex,aux_Hdpsi,aux_Hdpsi3,aux_dpsi,aux_dpsi3 = model.HO(CC.model,new_state,CC.t_list,t1,t2,t3)
...
def metropolis_constrained(CC,t1,t2,t3,niter,ndecorr,level=1,calc_derivs=False):
...
#            print(iter,iter_decorr,old_state,new_state,w)
    ...
    return res,Hdpsi/niter,Hdpsi2/niter, Hdpsi3/niter,dpsi/niter,dpsi2/niter,dpsi3/niter, states_list, aux_basis
